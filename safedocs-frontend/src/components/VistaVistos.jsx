        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-indigo-800 to-purple-800 dark:from-indigo-300 dark:to-purple-300 bg-clip-text text-transparent">
          ...
          <div className="flex items-center gap-3">
            <select
              ...
              className="px-4 py-2.5 border-2 border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 text-sm font-medium transition-all hover:border-gray-400 dark:hover:border-gray-600 shadow-sm"
            >
            ...
            <button
              onClick={loadViews}
              disabled={loading}
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border-2 border-indigo-200 dark:border-indigo-800 text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/20 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 transition-all duration-200 disabled:opacity-60 hover:scale-105 active:scale-95 shadow-sm hover:shadow font-medium"
              title="Actualizar"
            >
